...
our %config = (
  ...
  LDFLAGS => [  ],
  LDLIBS => [  ],
  PERL => "/usr/local/Cellar/perl/5.30.0/bin/perl",
  RANLIB => "ranlib",
  RC => "windres",
  RCFLAGS => [  ],
  afalgeng => "",
  ...
  libdir => "",
  major => "1",
  makedepprog => "/opt/X11/bin/makedepend",
  minor => "1.1",
